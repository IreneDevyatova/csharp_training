...
namespace WebAddressbookTests
{
    ...
    class EntryModificationTests : EntryTestBase
    {
        [Test]
        public void EntryModificationByIconTest()
        {
            ...
            app.Entries.ModifyEntry(oldEntryData, newEntryData);
            Assert.AreEqual(oldEntries.Count, app.Entries.GetEntriesCount());

            List<EntryData> newEntries = EntryData.GetAll();
            oldEntryData.Firstname = newEntryData.Firstname;
            oldEntryData.Lastname = newEntryData.Lastname;
            oldEntries.Sort();
            newEntries.Sort();
